...
class TodoService:
    ...
    def get_all_todos(self) -> List[TodoResponse]:
        ...
        return [TodoResponse(id=todo.id, title=todo.title, description=todo.description, completed=todo.completed) for todo in todos]
    ...
    def get_todo_by_id(self, todo_id: int) -> TodoResponse:
        ...
        return TodoResponse(id=todo.id, title=todo.title, description=todo.description, completed=todo.completed)
    ...
    def update_todo(self, todo_id: int, update_data: TodoUpdate) -> TodoResponse:
        ...
        return TodoResponse(id=updated_todo.id, title=updated_todo.title, description=updated_todo.description, completed=updated_todo.completed)
